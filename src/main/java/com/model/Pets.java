...
//    @JsonIgnore
	...
	public Pets(int petId, @NotNull @Size(max = 255) String name, @Size(max = 50) String breed, @Positive int age,
			@Positive float price, String description, @Size(max = 255) @Size(max = 255) byte[] imageUrl, PetCategories category,
	...
	public @Size(max = 255) byte[] getImageUrl() {
		return imageUrl;
	}

	public void setImageUrl(@Size(max = 255) byte[] imageUrl) {
		this.imageUrl = imageUrl;
	}
